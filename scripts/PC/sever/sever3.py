...
def minha_thread():
    ...
    global enable_pulsador
    global serial_giroscopio
    global enable_giroscopio
    global ddd
    global cont
    ...
    for port in ports:
        ...
        if port.serial_number == "56CA000930" or port.serial_number == "5598007147" or port.serial_number == "5698011281" or port.serial_number == "5767002927" or port.serial_number == "EC:DA:3B:BF:A7:60":
            if enable_giroscopio == True:
                ...
                print("Comunicação estabelecida, testando para verificar o funcionamento")
                _ = serial_giroscopio.read()
                print("Comunicação serial OK")
                print("")
            else:
                print("Atenção, foi detectada um módulo giroscópio configurado, entretanto ele está desabilitado "
            ...
            if enable_pulsador == True:
                ...
                print("Atenção, foi detectada um módulo pulsador configurado, entretanto ele está desabilitado "
                      "VERIFICAR CONFIGURAÇÕES")
