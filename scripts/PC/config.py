...
camera_id = 0          # Defina o id da câmera (Padrão: 0, Valores Possíveis: Inteiros)
...
border_black_windowing = True # Aplica o escurecimento nas bordas das imagens (Padrão: True, Valores Possíveis: True, False)
